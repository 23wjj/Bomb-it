...
static void InitColors(void)
{
    ...
    DefineColor("LightYellow",.95,.87,.54);
	DefineColor("DarkOrange",.99,.59,0);
	DefineColor("LightOrange",1,.74,.52);
	DefineColor("WhiteOrange",1,.88,.71);
	DefineColor("DarkGreen",.13,.70,.66);
	DefineColor("LightGreen",.28,.82,.80);
	DefineColor("WhiteGreen",.82,.93,.82);
	DefineColor("TreeGreen",.33,.80,.33);
    DefineColor("LightPink",1,.75,.79);
    DefineColor("DarkPink",1,.59,.59);
    DefineColor("Violet", .93, .5, .93);
    DefineColor("Magenta", 1, 0, 1);
    DefineColor("Cyan", 0, 1, 1);
    DefineColor("Flesh", .952, .795, .619);
    DefineColor("Aliceblue",.94,.97,1);//很浅 
	DefineColor("Powderblue",.69,.88,.90);//较深     
	DefineColor("Lightcyan",.88,1,1);
	DefineColor("Lightcyan",.88,1,1);
    DefineColor("Mediumslateblue", .482, .408, .933);
	//mediumslateblue 123 104 238  = .482, .408 .933
	DefineColor("Mediumslateblue(S1)", .282, .208, .733);
	//mediumslateblue's shallow
	DefineColor("Mediumslateblue(S2)", .312, .238, .763);
	//mediumslateblue's shallow
	DefineColor("Mediumslateblue(S3)", .362, .288, .813);
	//mediumslateblue's shallow
    DefineColor("Darkkhaka", .741, .718, .420);
    //darkkhaka 189 183 107 = .741, .718, .420
    DefineColor("Darkkhaka(S1)", .601, .528, .230);
    //darkkhaka's shallow 
    DefineColor("Moccasin", 1, .894, .710);
    //moccasin 255 228 181 = 1, .894, .710
    DefineColor("SteelBlue", .388, .722, 1);
    //SteelBlue 99 184 255 = .388, .722, 1
	DefineColor("SteelBlue1", .288, .822, 1);
    //SteelBlue 99 184 255 = .388, .722, 1 
    DefineColor("SteelBlue2", .310, .580, .804);
    //SteelBlue's shade
	DefineColor("Purple", .628, .126, .941);
	//Purple 160 32 240 = .628, .126, .941
	DefineColor("Purple1", .828, .426, 1);
	//purple's shade
	DefineColor("Purple2", .328, .026, .741);
	//purple's shade
	DefineColor("Gold", 1, .843, 0);
	//Gold 255,215,0 = 1, .843, 0
	DefineColor("Turquoise", .351, .978, .816);
	//Turquoise	绿宝石	#40E0D0	64,224,208
	DefineColor("DeepSkyBlue", 0, .749, 1);
	//	DeepSkyBlue 0 191 255
	DefineColor("GoldEnrod", .855, .647, .125);
	//GoldEnrod	秋麒麟 218,165,32 = .855, .647, .125
	DefineColor("Powderblue",.69,.88,.90);
    DefineColor("Darkgoldenrod",.72,.52,.04);
    
    DefineColor("Chocolate",.824, .412, .118);
    DefineColor("Chocolate(S)",.624, .312, .098);
    // Chocolate 210,105,30 = .824, .412, .118
    DefineColor("IndianRed",1, .416, .416);
    DefineColor("IndianRed(S)",0.8, .216, .216);
    //Goldenrod1	255 193 37
    DefineColor("DeepPink",1, .078, .573);
    DefineColor("DeepPink(S)",.8, .078, .373);
    //DeepPink	255 20 147
    DefineColor("RoyalBlue",.306, .463, 1);
    DefineColor("RoyalBlue(S)",.206, .263, 0.8);
    //RoyalBlue 78 118 255
    DefineColor("Aliceblue",.94,.97,1);//很浅
	DefineColor("BombOrange",1,.80,.40);
    DefineColor("AnotherOrange",1,.80,0);
    DefineColor("TitleYellow",1,1,.4);
    DefineColor("TitleGreen",0,.80,.60); 
}
